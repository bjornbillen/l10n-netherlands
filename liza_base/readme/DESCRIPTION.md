...
The [Liza app for Odoo](https://www.liza.nl) offers direct access to accurate, up-to-date and reliable business data on companies in Belgium, the Netherlands and Luxembourg.
...
Create new contacts in seconds by entering a company name, VAT, or registration number, and enrich existing records with a single click using the Liza button. Save hours of manual verification and avoid data entry errors and inconsistencies.
